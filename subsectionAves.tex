...
\item[arbírea:] àrvores acima de 300cm de altura. 
\end{enumerate}
...
primeira campanha. A probabilidade de ocupação do  Tico-tico do campo  (\textit{Ammodramus humeralis}, 75 registros) 
diferiu entre três fitofisionomias amostradas
(Fig.~\ref{fig:aves5}), ao comtrário de sua detecção. 
...
Dentro do raio de 100m em torno dos pontos foram
...
no estrato 4 (Fig.~\ref{fig:aves4}). No entanto, não é possível
